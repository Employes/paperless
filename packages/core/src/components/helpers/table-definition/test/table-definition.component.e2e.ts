...
describe('p-table-definition', () => {
    it('renders', async () => {
        ...
        await page.setContent('<p-table-definition>#</p-table-definition>');
        const element = await page.find('p-table-definition');
    ...
    it('renders changes to the content', async () => {
        ...
        await page.setContent('<p-table-definition>1</p-table-definition>');
